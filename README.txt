Thu Jan  2 09:23:57 EST 2014

--
This is a temporary fork, specifically to work on translating pfSense to Japanese.
...
--
このファイルに記載されている以下の機械翻訳のためご容赦ください。

これは、特に日本語にpfSenseを翻訳上で動作するように、一時的なフォークです。

ステータス：ラフ機械翻訳は、この変換を高速化する試みで、行われている。今では、人間の校正者のミスを修正するための時間です！

編集する1。POロケールファイルは、現在用意されて
<pfsense-repo>/usr/local/share/locale/pt_BR.ISO8859-1/LC_MESSAGES/pfSense.po

参考までに、このファイルには、ポルトガル語（ブラジル）や英語の翻訳で設定した規則に従う
<pfsense-repo>/usr/local/share/locale/pt_BR.ISO8859-1/LC_MESSAGES/pfSense.po
<pfsense-repo>/usr/local/share/locale/en/LC_MESSAGES/pfSense.pot

あなたは日/英のバイリンガルである場合は、この翻訳に協力したい場合は、レポ·アクセスにお気軽に。

あなたは非技術とバイリンガルであれば、あなたは助けることができる場所を確認するために、ike at blackskyresearch dot netに連絡して自由に感じる。
